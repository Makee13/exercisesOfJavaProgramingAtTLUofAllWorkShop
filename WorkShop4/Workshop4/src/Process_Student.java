...
public class Process_Student {
    ...
    public ArrayList<String> getCBItems = new ArrayList<>();
...
//              Đọc lần lượt giá trị trong ResultSet đặt cho Student
                ...
                if(!getCBItems.contains(rs.getString("ClassID")))
                      getCBItems.add(rs.getString("ClassID")); 
    ...
    public void updateCBItems(JComboBox JCB) {
